        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px;max-width:100%; border-radius: 5px 5px 0 0px; overflow: hidden; margin: 30px auto; box-shadow: 0 0 10px 5px rgba(0,0,0,0.05);">
            <tbody>
                ...
                <tr>
                    <td style="padding-top: 0;">
                        <p style="color: #545065;font-size:16px;">
                            You have successfully created a Love Push account. Please use below code to verify your email address and complete your registration.
                        </p>
                    </td>
                </tr>
                <br>
                <tr>
                    <td>
                    <p></p>
                        <a href="javascript:;" style="height: 43px;
                                                    background: #207ad1;
