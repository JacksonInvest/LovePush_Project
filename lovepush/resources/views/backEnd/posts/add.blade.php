				...
				<div class="form-group row">
					<div class="col-md-8 ">
						...
						<select name="post_type" class="form-control">
							...
							<option value="1">Love Ads</option>
							<option value="2">Connect Ads</option>
						</select>
					</div>
				</div>
				...
				<div class="form-group row">
					<div class="col-md-8 ">
						...
						<select name="is_post_anonymously" class="form-control">
							...
							<option value="2">Profile hidden</option>
						</select>
					</div>
				</div>
...
<script>
 ...
 <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAzMX9ojQ_Ct2ww7B2wsDpn0T2F6aexqHs&libraries=places"></script>
 <script>
 	function initialize() {
...
@endsection@extends('backEnd.layouts.base')
