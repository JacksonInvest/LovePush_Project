            ...
            if($request->question_id == 18) {
                ...
                if(!empty($res['scores'])) {
                    ...
                    foreach ($new_res as $key => $res) { 
                        ...
                        $save->max_allowed_scores = $res[0]['max_allowed_scores'];
                        $save->test_que_1         = $res[0]['test_que_1'];
                        $save->test_que_2         = $res[0]['test_que_2'];
                        $save->test_id_1          = $res[0]['test_id_1'];
                        $save->test_id_2          = $res[0]['test_id_2'];
