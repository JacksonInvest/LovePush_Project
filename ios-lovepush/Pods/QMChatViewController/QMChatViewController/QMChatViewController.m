...
- (void)viewDidLoad {
    ...
    self.inputToolbar.contentView.leftBarEmojiButtonItem = [self accessoryEmojiButtonItem];
    self.inputToolbar.contentView.leftBarButtonItem = [self accessoryButtonItem];
    self.inputToolbar.contentView.rightBarButtonItem = [self sendButtonItem];
    self.inputToolbar.contentView.rightBarMikeButtonItem = [self mikeButtonItem];
...
- (UIButton *)accessoryEmojiButtonItem {
    
    UIImage *accessoryEmojiImage = [QMChatResources imageNamed:@"smile_ic"];
    
    UIImage *normalImage = [accessoryEmojiImage imageMaskedWithColor:[UIColor lightGrayColor]];
    UIImage *highlightedImage = [accessoryEmojiImage imageMaskedWithColor:[UIColor darkGrayColor]];
    
    UIButton *accessoryEmojiButton =
    [[UIButton alloc] initWithFrame:CGRectMake(0.0f, 0.0f, accessoryEmojiImage.size.width, 32.0f)];
    [accessoryEmojiButton setImage:normalImage forState:UIControlStateNormal];
    [accessoryEmojiButton setImage:highlightedImage forState:UIControlStateHighlighted];
    
    accessoryEmojiButton.contentMode = UIViewContentModeScaleAspectFit;
    accessoryEmojiButton.backgroundColor = [UIColor clearColor];
    accessoryEmojiButton.tintColor = [UIColor lightGrayColor];
    
    return accessoryEmojiButton;
}

- (UIButton *)accessoryButtonItem {
    
    UIImage *accessoryImage = [QMChatResources imageNamed:@"attach_ic"];
...
- (UIButton *)mikeButtonItem {
    
    UIImage *mikeImage = [QMChatResources imageNamed:@"mike_ic"];
    
    UIImage *normalImage = [mikeImage imageMaskedWithColor:[UIColor lightGrayColor]];
    UIImage *highlightedImage = [mikeImage imageMaskedWithColor:[UIColor darkGrayColor]];
    
    UIButton *mikeButton =
    [[UIButton alloc] initWithFrame:CGRectMake(0.0f, 0.0f, mikeImage.size.width, 32.0f)];
    [mikeButton setImage:normalImage forState:UIControlStateNormal];
    [mikeButton setImage:highlightedImage forState:UIControlStateHighlighted];
    
    mikeButton.contentMode = UIViewContentModeScaleAspectFit;
    mikeButton.backgroundColor = [UIColor clearColor];
    mikeButton.tintColor = [UIColor lightGrayColor];
...
- (UIButton *)sendButtonItem {
    ...
    UIImage *sendImage = [QMChatResources imageNamed:@"send_ic"];
    
    UIImage *normalImage = [sendImage imageMaskedWithColor:[UIColor colorWithRed:184.0/255.0 green:2.0/255.0 blue:25.0/255.0 alpha:1.0f]];
    UIImage *highlightedImage = [sendImage imageMaskedWithColor:[UIColor colorWithRed:184.0/255.0 green:2.0/255.0 blue:25.0/255.0 alpha:1.0f]];
    
    UIButton *sendButton =
    [[UIButton alloc] initWithFrame:CGRectMake(0.0f, 0.0f, sendImage.size.width, 32.0f)];
    ...
    sendButton.tintColor = [UIColor colorWithRed:184.0/255.0 green:2.0/255.0 blue:25.0/255.0 alpha:1.0f];
...
- (void)didPressEmojiButton:(UIButton *)sender {
    
}

- (void)didPressAudioButton:(UIButton *)sender {
    QMAudioRecordView* audioRecordView = [QMAudioRecordView loadAudioRecordView];
    audioRecordView.delegate = self;
    audioRecordView.frame = self.inputToolbar.contentView.frame;
...
- (UICollectionViewCell *)collectionView:(QMChatCollectionView *)collectionView
    ...
    if ([messageItem attachments] != nil || [[messageItem attachments] count] != 0) {
        ...
        NSArray *attachments = [messageItem attachments];
        
         NSLog(@"MESSSSAGE___>%@",attachments);
        
        QBChatAttachment *attachment = [attachments firstObject];
        
        if ([[attachment type] isEqualToString:@"audio"]) {
            
            if ([itemIdentifier isEqualToString: @"QMChatAttachmentOutgoingCell"] || [itemIdentifier isEqualToString: @"QMChatAttachmentIncomingCell"]) {
                if ([itemIdentifier isEqualToString: @"QMChatAttachmentOutgoingCell"]) {
                    
                    QMChatCell *cell =
                    [collectionView dequeueReusableCellWithReuseIdentifier:@"QMAudioOutgoingCell"
                    ...
                    QMChatCell *cell =
                    [collectionView dequeueReusableCellWithReuseIdentifier:@"QMAudioIncomingCell"
                                                              forIndexPath:indexPath];
                    [self collectionView:collectionView configureCell:cell forIndexPath:indexPath];
...
- (void)collectionView:(QMChatCollectionView *)collectionView
    ...
    if ([cell isKindOfClass:[QMChatCell class]]) {
        ...
        if ([cell isKindOfClass:[QMChatIncomingCell class]]
            ...
            || [cell isKindOfClass:[QMAudioOutgoingCell class]]
            || [cell isKindOfClass:[QMAudioIncomingCell class]]) {
...
- (void)messagesInputToolbar:(QMInputToolbar *)toolbar didPressEmojiBarButton:(UIButton *)sender {
    
    [self didPressEmojiButton: sender];
}
...
- (void)messagesInputToolbar:(QMInputToolbar *)toolbar didPressRightBarMikeButton:(UIButton *)sender {
