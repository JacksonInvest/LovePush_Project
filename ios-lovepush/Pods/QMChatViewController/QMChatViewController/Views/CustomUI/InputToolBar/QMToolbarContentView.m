...
@property (weak, nonatomic) IBOutlet UIView *leftBarButtonEmojiContainerView;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *leftBarButtonContainerViewWidthConstraint;

@property (weak, nonatomic) IBOutlet UIView *rightBarButtonMikeContainerView;
...
- (void)setBackgroundColor:(UIColor *)backgroundColor {
    ...
    self.leftBarButtonEmojiContainerView.backgroundColor = backgroundColor;
    self.leftBarButtonContainerView.backgroundColor = backgroundColor;
    self.rightBarButtonMikeContainerView.backgroundColor = backgroundColor;
...
- (void)setLeftBarEmojiButtonItem:(UIButton *)leftBarEmojiButtonItem {
    
    if (_leftBarEmojiButtonItem) {
        [_leftBarEmojiButtonItem removeFromSuperview];
    }
    
    if (!leftBarEmojiButtonItem) {
        _leftBarEmojiButtonItem = nil;
        self.leftHorizontalSpacingConstraint.constant = 0.0f;
        self.leftBarButtonItemWidth = 0.0f;
        self.leftBarButtonContainerView.hidden = YES;
    ...
    if (CGRectEqualToRect(leftBarEmojiButtonItem.frame, CGRectZero)) {
        leftBarEmojiButtonItem.frame = self.leftBarButtonEmojiContainerView.bounds;
    }
    
    self.leftBarButtonEmojiContainerView.hidden = NO;
    self.leftHorizontalSpacingConstraint.constant = kQMToolbarContentViewHorizontalSpacingDefault;
    self.leftBarButtonItemWidth = CGRectGetWidth(_leftBarEmojiButtonItem.frame);
    
    [leftBarEmojiButtonItem setTranslatesAutoresizingMaskIntoConstraints:NO];
    
    [self.leftBarButtonEmojiContainerView addSubview:leftBarEmojiButtonItem];
    [self.leftBarButtonEmojiContainerView pinAllEdgesOfSubview:leftBarEmojiButtonItem];
    [self setNeedsUpdateConstraints];
    
    _leftBarEmojiButtonItem = leftBarEmojiButtonItem;
}
...
- (void)setRightBarMikeButtonItem:(UIButton *)rightBarMikeButtonItem {
    
    if (_rightBarMikeButtonItem) {
        [_rightBarMikeButtonItem removeFromSuperview];
    }
    
    if (!rightBarMikeButtonItem) {
        _rightBarMikeButtonItem = nil;
    ...
    if (CGRectEqualToRect(rightBarMikeButtonItem.frame, CGRectZero)) {
        rightBarMikeButtonItem.frame = self.rightBarButtonContainerView.bounds;
    }
    
    self.rightBarButtonMikeContainerView.hidden = NO;
    self.rightHorizontalSpacingConstraint.constant = kQMToolbarContentViewHorizontalSpacingDefault;
    self.rightBarButtonItemWidth = CGRectGetWidth(rightBarMikeButtonItem.frame);
    
    [rightBarMikeButtonItem setTranslatesAutoresizingMaskIntoConstraints:NO];
    
    [self.rightBarButtonMikeContainerView addSubview:rightBarMikeButtonItem];
    [self.rightBarButtonMikeContainerView pinAllEdgesOfSubview:rightBarMikeButtonItem];
    [self setNeedsUpdateConstraints];
    
    _rightBarMikeButtonItem = rightBarMikeButtonItem;
}
