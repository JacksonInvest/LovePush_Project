...
@IBDesignable open class RangeSeekSlider: UIControl {
    ...
    private var leftHandleAccessibilityElement: UIAccessibilityElement {
        ...
        element.accessibilityTraits = UIAccessibilityTraitAdjustable//UIAccessibilityTraits.adjustable
        return element
    }
...
//        minLabel.alignmentMode = CATextLayerAlignmentMode.CFTypeRef.center//CATextLayerAlignmentMode.center
