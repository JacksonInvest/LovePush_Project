...
class WebAPI {
    ...
    class func requestToPostWithData(_ urlString: String, params getParams: [String:String],header: [String:Any],fileData: Data?, fileKey:String, completion: @escaping(_ responseData: AnyObject, _ isSuccess: Bool)-> Void) {
        ...
        Alamofire.upload(multipartFormData: { multipartFormData in
            ...
            if let data = fileData {
                multipartFormData.append(data, withName: fileKey,fileName: "furkan.png" , mimeType: "image/png")
            }
    ...
    class func requestToPOSTWithHeader(_ strURL : String, params : [String: Any], headers : [String : AnyObject]?, completion:@escaping (_ receivedData: AnyObject, _ isSuccess : Bool) -> Void) {
...
//        httpHeader!["Content-Type"] = "application/json" as AnyObject
        ...
        manager.request(urlValue, method: .post, parameters: params, encoding: JSONEncoding.default, headers:finalHeaders).responseJSON { response in
    ...
    class func requestToPostWithBodyForm(_ urlString : String, params : [String: Any], headers : [String : AnyObject]?, completion:@escaping (_ receivedData: AnyObject, _ isSuccess : Bool) -> Void) {
    ...
    class func gotToLogin(){
        if let rootVC = UIApplication.shared.keyWindow?.rootViewController {
            rootVC.showAlert(title: "Error", message: "Your session Expired, You have to login again.", completion: { (isYes) in
                Helper.sharedInstance.HideLoaderFromView(view: rootVC.view)
                self.simpleDelete()
            })
        }
    }
