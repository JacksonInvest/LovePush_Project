...
public class connectMatchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public connectMatchAdapter(List<UserChatList.Data> loveMatchList, Context context, OnItemClickListenerCutom listener) {
...
//                    .diskCacheStrategy(DiskCacheStrategy.NONE)).into(holder.user_IV);
        ...
        holder.imageProfile.setBorderColor(context.getResources().getColor(R.color.blue));
        ...
        holder.textUnblock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onItemClick(holder.textUnblock, pos, 1, datalist);
        ...
        holder.root_view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onItemClick(holder.textUnblock, pos, 2, datalist);
