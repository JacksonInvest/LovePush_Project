...
public class tipsMediaActivity extends BaseActivity {
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, tipsMediaActivity .class);
    }
    private Activity context = tipsMediaActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        screenTitleTV.setText("Tips & Media");
    ...
    protected void initUI(){
        ...
        if (webView == null)
        {
            ...
            webView.setWebViewClient(new tipsMediaActivity.SetWebClient());
