package com.lovepushapp.quickBloxTest.utils.qb;
...
public class VerboseQbChatConnectionListener implements ConnectionListener {
    ...
    public void reconnectingIn(final int seconds) {
        if (seconds % 5 == 0 && seconds != 0) {
            ...
            snackbar = Snackbar.make(rootView, MyApplication.getInstance().getString(R.string.reconnect_alert, String.valueOf(seconds)), Snackbar.LENGTH_INDEFINITE);
            snackbar.show();
        }
    }
