...
public class AttachmentPreviewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // Picasso.get().load(attachmentFile).resize(ResourceUtils.getDimen(R.dimen.chat_attachment_preview_size), ResourceUtils.getDimen(R.dimen.chat_attachment_preview_size)).into(holder.attachmentImageView);

        Picasso.get().load(attachmentFile).into(holder.attachmentImageView);
