package com.lovepushapp.quickBloxTest.managers;
...
public class DialogsManager {
    ...
    private QBChatMessage buildMessageCreatedGroupDialog(QBChatDialog dialog) {
        ...
        qbChatMessage.setBody(MyApplication.getInstance().getString(R.string.new_chat_created, getCurrentUserName()));
    ...
    private QBChatMessage buildMessageAddedUsers(QBChatDialog dialog, String userIds, String usersNames) {
        ...
        qbChatMessage.setBody(MyApplication.getInstance().getString(R.string.occupant_added, getCurrentUserName(), usersNames));
        qbChatMessage.setSaveToHistory(true);
        qbChatMessage.setMarkable(true);
        return qbChatMessage;
    }
    ...
    private QBChatMessage buildMessageLeftUser(QBChatDialog dialog) {
        ...
        qbChatMessage.setBody(MyApplication.getInstance().getString(R.string.occupant_left, getCurrentUserName()));
        qbChatMessage.setSaveToHistory(true);
        qbChatMessage.setMarkable(true);
        return qbChatMessage;
    }
