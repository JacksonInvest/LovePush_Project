package com.lovepushapp.videoTestJava.services;
...
import com.lovepushapp.videoTestJava.util.NetworkConnectionChecker;
...
import static com.lovepushapp.videoTestJava.utils.Consts.MAX_OPPONENTS_COUNT;
...
//        return START_STICKY;
    ...
    private Notification initNotification() {
        ...
        Log.e("CALL_SERVICE","TRUE");


        Intent notifyIntent = new Intent(this, CallActivity.class);
//        notifyIntent.putExtra(Consts.EXTRA_IS_INCOMING_CALL,true);
