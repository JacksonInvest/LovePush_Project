...
public class CoreApp extends Application
{
    ...
    private void initQbConfigs() {
        ...
        qbConfigs = CoreConfigUtils.getCoreConfigsOrNull(getQbConfigFileName(),getApplicationContext());
    }
    ...
    public void initCredentials(){
        if (qbConfigs != null) {
            ...
            if (!TextUtils.isEmpty(qbConfigs.getApiDomain()) && !TextUtils.isEmpty(qbConfigs.getChatDomain())) {
                QBSettings.getInstance().setEndpoints(qbConfigs.getApiDomain(), qbConfigs.getChatDomain(),
