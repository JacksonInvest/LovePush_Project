...
public class CardStackLayoutManager
    ...
    private static CardStackSetting setting = new CardStackSetting();
...
*/
    ...
    public static void setCanScrollHorizontal(boolean canScrollHorizontal) {
        setting.canScrollHorizontal = canScrollHorizontal;
    }

    public static void setCanScrollVertical(boolean canScrollVertical) {
